  ...
  return (
    <div className="min-h-screen w-full bg-[var(--bg-primary)] text-[var(--text-primary)] flex items-center justify-center p-4 relative overflow-hidden select-none">
      ...
      >
        ...
        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-violet-500 via-indigo-500 to-purple-500 rounded-t-2xl" />
        ...
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <p className="text-xs text-[var(--text-secondary)] mt-1">Start managing and testing your APIs today</p>
        </div>
